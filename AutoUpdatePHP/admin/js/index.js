...
$(document).on("click", "input:button#uploadbtn",
    function() {
        ...
        <input onclick='checkFile(this);' id=\"" + parseInt(i - 1) + "\" type=\"file\" name=\"files[]\" multiple=\"\">\
                    ...
                    mhtml += "<td>" + parseInt(i) + "</td><td id='data" + parseInt(i - 1) + "' >" + arr[i - 1] + "</td><td>" + edibtn + "</td><td>" + delbtn + "</td>";
                    mhtml += "</tr>"
                }
...
function addOne(tt) {
    ...
    var mhtml = "<tr>";
    //  mhtml += "<tr><td>" +parseInt(i) + "</td><td>" + arr[i] + "</td><td>"+editbtn+"</td>"+ "</td><td>"+delbtn+"</td></tr>";
    mhtml += "<td>" + parseInt(t01) + "</td><td id='data" + parseInt(t01 - 1) + "' >" + "未上传" + "</td><td>" + edibtn + "</td><td>" + delbtn + "</td>";
    mhtml += "</tr>"
